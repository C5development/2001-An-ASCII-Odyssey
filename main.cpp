                ...
                if(selection == 1){
                    ...
                    while(1){
                        ...
                        if(desired_amount > planets[choice - 1].getdiamonds()){
                            std::cout<<"There is not that much metal my lord"<<std::endl;
                        }
                        else
                            break;
                    }
...
void Spaceship::interstellar_travel( bool back_to_solar_system)
{
    ...
    while(1){
        ...
        switch(solarsystemchoice){
            ...
            case 1: back_to_solar_system = true; //DATABASE EXTRACTING DATA TO DISPLAY PLANETS ON THE SCREEN
        ...
        while(1){
            ...
            if(choice == 1){
                if(choice == 2)
                    ...
                    for(int j = _soldierslevel; j < prices.size(); j++){
                        std::cout<<prices[j]<<std::endl;
                    }
